...
from v2.indicators import ewmac, adx, atr
...
class EwmacTrend(StrategyBase):
    ...
    def __init__(self, cfg: dict):
        super().__init__(cfg)
        self.fast_1 = int(cfg.get("ewmac_fast_1", 8))
        self.slow_1 = int(cfg.get("ewmac_slow_1", 32))
        self.fast_2 = int(cfg.get("ewmac_fast_2", 16))
        self.slow_2 = int(cfg.get("ewmac_slow_2", 64))
        self.signal_threshold = float(cfg.get("ewmac_threshold", 0.005))
        self.min_adx = float(cfg.get("ewmac_min_adx", 20.0))
        self.position_pct = float(cfg.get("ewmac_position_pct", 0.05))
        self.sl_atr_mult = float(cfg.get("ewmac_sl_atr_mult", 2.0))
        self.tp_atr_mult = float(cfg.get("ewmac_tp_atr_mult", 3.0))
        self.slippage_pct = float(cfg.get("ewmac_slippage_pct", 0.0003))
