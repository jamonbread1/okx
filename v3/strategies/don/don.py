...
from v3.indicators import adx, atr
...
class DonchianBreakout(StrategyBase):
    ...
    def __init__(self, cfg: dict):
        ...
        self.period = int(cfg.get("period", 28))
        self.min_adx = float(cfg.get("min_adx", 25.0))
        self.vol_ratio = float(cfg.get("vol_ratio", 1.3))
        self.max_wick_ratio = float(cfg.get("max_wick_ratio", 2.0))
        ...
        self.calc_window = int(cfg.get("calc_window", 250))
